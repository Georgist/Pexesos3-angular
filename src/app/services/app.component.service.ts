...
export class AppComponentService {
  ...
  constructor(public statesService: StatesService, private modalService: ModalService, private timerService: TimerService, private gameInfoPanelService: GameInfoPanelService) {}
